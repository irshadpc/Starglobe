...
- (STexture *)textureWithImageNamed:(NSString *)name
{
    ...
    if([name hasPrefix:prefix]) {
        ...
        return [[STexture alloc] initWithImage:img inView:self.view];
    }
    
    return [[STexture alloc] initWithImageNamed:name inView:self.view];
}
...
- (void)didBecomeActive
{
    ...
    STexture *backgroundTexture = [[STexture alloc] initWithImageNamed:@"star-map.jpg" inView:self.view scaledDown:NO];
...
- (void)update:(CGFloat)dt
{
    ...
    [self checkKey:@"shadowsValue" forNeedToChangeInRangeMin:0.0f max:1.0f givenEnabled:YES];
    [self checkKey:@"glowValue" forNeedToChangeInRangeMin:0.0f max:1.0f givenEnabled:YES];
    [self checkKey:@"cloudsValue" forNeedToChangeInRangeMin:0.0f max:1.0f givenEnabled:YES];
