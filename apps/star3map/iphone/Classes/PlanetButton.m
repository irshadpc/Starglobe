...
+ (UIImage *)thumbnailImage:(UIImage *)texture hasRings:(BOOL)hasRings ringColor:(CC3Vector)ringColor ringsTemplate:(NSString *)ringsName
{
    ...
    CGRect withRingsPlanetFrame = CGRectMake(0.37f * size.width,
                                                          0.33f * size.height,
                                                          0.27f * size.width,
                                                          0.27f * size.height);
    CGFloat withoutRingsPlanetScale = 0.6f;
    CGRect withoutRingsPlanetFrame = CGRectMake((1.0f - withoutRingsPlanetScale) / 2.0f * size.width,
...
- (id)initWithFrame:(CGRect)frame json:(NSDictionary *)json
{
    ...
    if (self) {
        ...
        [self.nameLabel setFont:[UIFont fontWithName:@"HelveticaNeue-Light" size:16]];
        self.nameLabel.frame = CGRectMake(CGRectGetHeight(self.backgroundImageView.frame), 0, CGRectGetWidth(frame) - CGRectGetHeight(frame), CGRectGetHeight(frame));
        ...
        self.infoButton.frame = CGRectMake(CGRectGetWidth(frame) - 100, 0, 50, CGRectGetHeight(frame));
