...
- (void)createWorld
{
    ...
    if(self.data.texture0) {
        [self.body addTexture:[[STexture alloc] initWithImageNamed:self.data.texture0]];
    }
    if(self.data.texture1) {
        [self.body addTexture:[[STexture alloc] initWithImageNamed:self.data.texture1]];
    }
    ...
    if(self.data.rings.enabled) {
        ...
        [self.rings addTexture:[[STexture alloc] initWithImageNamed:self.data.rings.texture]];
    ...
    if(self.data.clouds.enabled) {
        ...
        self.body.overlayTexture = [[STexture alloc] initWithImageNamed:self.data.clouds.texture0];
